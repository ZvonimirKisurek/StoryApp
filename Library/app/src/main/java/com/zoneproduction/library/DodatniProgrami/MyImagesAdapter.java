...
public class MyImagesAdapter extends RecyclerView.Adapter<MyImagesAdapter.MyImagesHolder> {
    ...
    public class MyImagesHolder extends RecyclerView.ViewHolder{
        ...
        public MyImagesHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.imageViewCardImage);
            textViewTitle = itemView.findViewById(R.id.textViewTitleImageCard);
            textViewDescription = itemView.findViewById(R.id.textViewDescriptionImageCard);
