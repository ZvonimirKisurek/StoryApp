...
public class FragmentUnitedKingdom extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imageViewUnitedKingdom = view.findViewById(R.id.imageViewUK);
        progressBarUnitedKingdom = view.findViewById(R.id.progressBarUK);

        Picasso.get().load("https://upload.wikimedia.org/wikipedia/en/thumb/a/ae/" +
                "Flag_of_the_United_Kingdom.svg/1280px-Flag_of_the_United_Kingdom.svg.png").into(imageViewUnitedKingdom, new Callback() {
            @Override
