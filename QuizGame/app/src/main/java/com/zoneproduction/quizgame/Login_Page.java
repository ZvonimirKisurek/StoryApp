package com.zoneproduction.quizgame;
...
public class Login_Page extends AppCompatActivity {
        ...
        auth.signInWithEmailAndPassword(userEmail,userPassword).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    finish();
                    progressBarSignIn.setVisibility(View.INVISIBLE);
                    Toast.makeText(Login_Page.this, "Sign in is Succesful", Toast.LENGTH_LONG).show();

                }else{
                    Toast.makeText(Login_Page.this, "Sign in is not Succesful", Toast.LENGTH_LONG).show();
                }
    ...
    private void firebaseSignInWithGoogle(Task<GoogleSignInAccount> task){
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(Login_Page.this, "Signed in is not Successful", Toast.LENGTH_LONG).show();
        }
    }
