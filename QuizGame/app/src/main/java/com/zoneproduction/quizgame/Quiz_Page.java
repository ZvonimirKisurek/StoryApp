        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(questionNumber < questionCount){
                    ...
                    Toast.makeText(Quiz_Page.this, "You answered all question", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public void sendScore(){
        ...
        databaseReferenceSecond.child("scores").child(userUID).child("correct").setValue(userCorrect).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(Quiz_Page.this, "scores sent succesfully", Toast.LENGTH_LONG).show();
