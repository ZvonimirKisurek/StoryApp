...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewTotalWrong.setText("Total Correct Answer : " + wrong);
        textViewTotalEmpty.setText("Total Correct Answer : " + empty);
        textViewSuccess.setText("Total Correct Answer : " + (correct * 10));
